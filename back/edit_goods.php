...
<form action="./api/save_goods.php" method="post" enctype="multipart/form-data">
    <table class="all">
        ...
        <tr>
            ...
            <td class="pp"><input type="file" name="img" value="<?= $goods['img'] ?>"></td>
        </tr>
        <tr>
            <th class="tt ct">商品介紹</th>
            <td class="pp"><textarea name="intro" style="width:80%;height:150px;">
<?= $goods['intro'] ?>
        </textarea></td>
        </tr>
    </table>
    ...
    <input type="hidden" name="id" value="<?= $goods['id'] ?>">
        ...
        <input type="button" value="返回" onclick="location.href='?do=th.php'">
    </div>
</form>
